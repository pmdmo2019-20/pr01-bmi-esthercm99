...
public class MainActivity extends AppCompatActivity {
    ...
    private void reset() {
        ...
        ImageView image = ActivityCompat.requireViewById(this, R.id.imageResult);
    ...
    private void showResult() {
        ...
        if(isCorrect(weightText, heightText)) {
            ...
            result.setText(getString(R.string.resultBMI, resultCalc, bmi.getBmiClasification(resultCalc).toString().replace("_", " ")));
    ...
    private boolean isCorrect(EditText weightText, EditText heightText) {
        ...
        if (heightText.getText().toString().isEmpty()) {
            heightText.setError("Invalid height");
        } else {
